...
function loadAbout() {
  ...
  const aboutParagraph = createPara(
    "aboutPara",
    "At Arlo, we strive to create an experince for ramen lovers and newcomers alike.  Our traditional ramen selection has many options for all to try."
  );
